<cfinclude template="../connection/connection.cfc">
    ...
    <cfquery name="Navigation" datasource="#datasource#" maxrows="500">
        SELECT * FROM tbl_college_student ORDER BY id ASC
    </cfquery>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-stethoscope"></i> Health Profession - View Rotations</h2>
            ...
            <div class="panel panel-dark">
                <div class="panel-heading">
                    <ul class="pagination nomargin pull-right">
                        <a href="hpstudents.cfm" class="btn btn-primary">Add Rotation</a>
                            <button id="chatview" class="btn btn-primary">
                				<i class="fa fa-search"></i>
            				</button>
                    </ul>
                    <h4 class="panel-title">Showing All Rotations</h4>
                    <p><cfoutput>#Navigation.RecordCount#</cfoutput> result (0.50 ms)</p>
                </div><!-- panel-heading -->
          ...
          <table class="table" id="table2">
              ...
              <tbody>
               <cfloop query="Navigation">
                 <tr class="odd gradeX">
                    <td><a href="ae/vStudent.cfm?view=<cfoutput>#ID#</cfoutput>"><cfoutput>#ID#</cfoutput></a></td>
                    <td><cfoutput>#lname#</cfoutput></td>
                    <td><cfoutput>#fname#</cfoutput></td>
                    <td><cfoutput>#email#</cfoutput></td>
                    <td><cfoutput>#center_id#</cfoutput></td>
                 </tr>
				</cfloop>
