...
<!--Set up Page Variables for Header include-->
	<cfset This.PageName = 'Add Trainee'>
    ...
    <form class="form-horizontal form-bordered" id="addTrainee" method="Post">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title">Add New HP Trainee</h4>
          <p>Please use this form to add new a new trainee. Make sure to fill out all the required fields.</p>
          <p class="error"></p>
        </div>
        <div class="panel-body panel-body-nopadding">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select class="form-control" data-placeholder="Choose a Status..." name="status" required>
                <option value=""></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="text" placeholder="Enter Maiden Name" class="form-control" name="MaidenName">
            </div>
          </div>
        </div>
        <!-- panel-body --> 
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <select class="form-control chosen-select" data-placeholder="Choose an Institution..." name="InstitutionID" required>
                <option value=""></option>
                <cfoutput query="rInstitutions">
                    <option value="#ID#">#Institution#</option>
                  </cfoutput>
              </select>
              <label class="error" for="InstitutionID"></label>
            </div>
