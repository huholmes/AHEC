<cfinclude template="../connection/connection.cfc">
    ...
    <cfquery name="Preceptors" datasource="#datasource#">
        SELECT * FROM tbl_preceptors ORDER BY id ASC
    </cfquery>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-stethoscope"></i> Health Profession - View Preceptors</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="../index.php">Health Professions</a></li>
          <li class="active">Preceptors</li>
        </ol>
      </div>
    </div>
            ...
            <div class="panel panel-dark">
                <div class="panel-heading">
                  <ul class="pagination nomargin pull-right">
                        <a href="ae/vPreceptor.cfm" class="btn btn-primary">Add Preceptor</a>
                            <button id="chatview" class="btn btn-primary">
                				<i class="fa fa-search"></i>
            				</button>
                    </ul>
                    <h4 class="panel-title">Showing All Preceptors</h4>
                    <p><cfoutput>#Preceptors.RecordCount#</cfoutput> result (0.50 ms)</p>
                </div><!-- panel-heading -->
