...
<cffunction name="GetIns" access="remote" output="false" returntype="any" returnformat="json">
  
   <cfquery name="local.qryIns" datasource="azahec">
	SELECT ID,Institution FROM Institutions
  </cfquery>
 
  <cfscript>
  strData = StructNew();
  strData['aaData'] = QueryToArray(qryIns);
  return strData;
  </cfscript>
